# Contributing to @d1vij/shit-i-always-use
...
2. Clone your fork: `git clone https://github.com/d1vij/shit-i-always-use.git`
3. Navigate to the project directory: `cd shit-i-always-use`
...
If you have any questions, please [open an issue](https://github.com/d1vij/shit-i-always-use/issues/new) for discussion.

Thank you for contributing to @d1vij/shit-i-always-use!
